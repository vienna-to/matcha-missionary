...
import { CATEGORY_LABELS, type Ingredient } from "@/lib/types";
...
export default function Finance() {
  ...
  return (
    <div className="space-y-5">
      ...
      <Card>
        <h2 className="mb-3 text-sm font-semibold">Per-item costs</h2>
              ...
              {activeItems.map((item) => {
                ...
                return (
                  <tr key={item.id} className="border-t border-cream-100">
                    ...
                    <td className="py-2 pr-4 text-matcha-900/70">
      ...
      <Card>
        ...
        <p className="mb-3 text-xs text-matcha-900/60">
          $/unit is derived from package price and amount. Edit values in Menu
          Manager → Ingredients.
        </p>
        <div className="overflow-x-auto">
          <table className="min-w-full text-sm">
              ...
              {state.ingredients.map((ing: Ingredient) => {
                ...
                return (
                  <tr key={ing.id} className="border-t border-cream-100">
                    ...
                    <td className="py-2 pr-4">
                      {ing.pool ? <Badge>{ing.pool}</Badge> : null}
                    </td>
                    <td className="py-2 pr-4 text-right tabular-nums">
